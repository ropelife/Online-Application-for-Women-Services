...
/*echo "applicant_name : $applicant_name<br>husband_name: $husband_name<br>son_of: $son_of<br>address: $address<br>dob_mother: $dob_mother<br>dob_child: $dob_child<br>birth_place: $birth_place<br>no_of_child: $no_of_child<br>caste: $caste<br>amount_figures: $amount_figures<br>amount_words: $amount_words<br>policy no: $policy_no<br>date of Application: $da";*/
    ...
    *************************************************************************/
    ...
    {
        $insert_stmt->bind_param('ssssssdsdssss', $applicant_name, $husband_name, $son_of, $address, $dob_mother, $dob_child, $birth_place, $no_of_child, $caste, $amount_figures, $amount_words, $policy_no, $da);
       ...
       if (! $insert_stmt->execute()) 
        ...
        {
            $to = $email;
            $subject = 'Form Submission for BSY';
         ...
         //start of sms code
			...
			$mobileNumber = "8355954690";

			//Sender ID,While using route4 sender id should be 6 characters long.
			$senderId = "MAHGOV";
                 
        //Your message to send, Add URL encoding here.
			$message = urlencode("Your form has been successfully processed and your appointment is on 10/04/2017 at 10 am.");
