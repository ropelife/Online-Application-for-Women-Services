...
?>
    ...
    <head>
        <meta charset="utf-8" />
        <title>Varishtha Pension Yojna</title>
    ...
    <body class="page-header-fixed">
        ...
        <div class="header navbar navbar-inverse navbar-fixed-top">
            ...
            <div class="header-inner">
                <!-- BEGIN LOGO -->
                <a class="navbar-brand" href="/index.php"><br> </br> <img src="assets/img/vpy.png" alt="logo" class="img-responsive" width="180" /> </a>
                <!-- END LOGO -->
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <!-- BEGIN PAGE TITLE-->
                        <h3 class="page-title">
                  Varishtha Pension Yojana (BSY) <small>(No document other than the application form is necessary for obtaining the post birth benefit of Rs.500/-)</small>
               </h3>
                        <!-- END PAGE TITLE-->
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box green">
                            <div class="portlet-title">
                                <div class="caption"><i class="icon-reorder"></i>Varishtha Pension Yojana</div>
                            </div>
                            <div class="portlet-body form">
                                <!-- BEGIN FORM-->
                                <form action="http://localhost/anuja/scripts/add-bsy.php" id="form_bsy" class="form-horizontal" method="POST">
                                    <div class="form-body">
        ...
        <!-- BEGIN FOOTER -->
        <div class="footer">
            <div class="footer-inner"> 2017 &copy; By VESP Students. </div>
