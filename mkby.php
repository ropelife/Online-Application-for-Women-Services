                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box green">
                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="http://localhost/anuja/scripts/add-mkby.php" id="form_mkby" class="form-horizontal" method="POST">
                                    <div class="form-body">
										<h4><b>For Applicant(s):</b><h3>
                                        <!--Saving Textfield-->
									 ...
									 <button class="btn default" type="button"><i class="icon-calendar"></i></button>
                                        ...
                                        <!--End of Date Field--><hr>
										<h4><b>Detail of First Deposit</b><h4>
									<!-- Amounts rs textfield -->
									 ...
									 <button class="btn default" type="button"><i class="icon-calendar"></i></button>
										...
										<hr>
										<h4><b>Mandatory Fields to be filled by customer</b><h4>
