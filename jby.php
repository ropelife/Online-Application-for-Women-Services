...
?>
    <head>
        <meta charset="utf-8" />
        <title>JEEVANJYOTI BIMA YOJANA (JBY)</title>
    ...
    <body class="page-header-fixed">
        ...
        <div class="header navbar navbar-inverse navbar-fixed-top">
            ...
            <div class="header-inner">
                <!-- BEGIN LOGO -->
                <a class="navbar-brand" href="/index.php"><br> </br> <img src="assets/img/jby.jpg" alt="logo" class="img-responsive" width="180" /> </a>
                <!-- END LOGO -->
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <!-- BEGIN PAGE TITLE-->
                        <h3 class="page-title">
                 JEEVANJYOTI BIMA YOJNA (JBY)<small> JEEVANJYOTI KYC Application
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box green">
                            <div class="portlet-title">
                                <div class="caption"><i class="icon-reorder"></i>JEEVANJYOTI BIMA YOJANA (JBY)</div>
                            </div>
